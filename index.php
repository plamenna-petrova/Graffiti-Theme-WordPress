        ...
        <main id="main" class="site-main" role="main">
            ...
            <?php if( is_paged() ):?>
                ...
                <form method="post">
                    <div class="container text-center container-load-previous">
                        <a class="btn-graffiti-load graffiti-load-more" data-prev="1" data-page="<?= graffiti_check_paged(1); ?>" data-url="<?= admin_url('admin-ajax.php');?>">
            ...
            <form method="post">
                <div class="container text-center">
                    <a class="btn-graffiti-load graffiti-load-more" data-page="<?= graffiti_check_paged(1); ?>" data-url="<?= admin_url('admin-ajax.php');?>">
                        <span class="sunset-icon sunset-loading"></span>
