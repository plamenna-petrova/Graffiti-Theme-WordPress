...
<div id="comments" class="comments-area">
    ...
    if (have_comments()):
        ...
        <h2 class="comments-title">
            ...
            printf(
                esc_html(_nx('One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'graffititheme')),
        ...
        <?php graffiti_get_post_navigation(); ?>
        ...
        if (!comments_open() && get_comments_number()):
            ...
            <p class="no-comments"><?php esc_html_e('Comments are closed.', 'graffititheme'); ?></p>
